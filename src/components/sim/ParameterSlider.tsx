...
export function ParameterSlider({
  icon: Icon, label, unit, value, min, max, step = 0.1, onChange, hint, accent = "primary",
}: Props) {
  const accentColor =
    ...
    <div className="panel p-5 space-y-3">
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <div className="text-[10px] uppercase tracking-[0.18em] text-muted-foreground">Input</div>
